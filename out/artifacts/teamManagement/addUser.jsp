    ...
    <!--<script>
        $(document).ready(function(){
            $("#submit").click(function(){
                ...
                else if($("#paswd").val() == null || $("#paswd").val() ===""){
                    alert("密码不可为空！");
                }
                else if(!/^\w+@[a-z0-9]+(\.[a-z]+){1,3}$/.test($("#emails").val())){
                    alert("邮箱格式错误!");
                }
                else if(!/^1[3|4|5|8][0-9]\d{4,8}$/.test($("#telep").val())){
                    alert("手机号格式错误!");
                }
        ...
        <div class="collapse navbar-collapse" id="example-navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li style="position:absolute; right: 15px;">
                    <a href="#"><img src="img/admin.jpg" class="img-circle" style="width:30px; height:30px;" /><span style="font-size:20px;">administrator</span></a>
                </li>
            </ul>
        </div>
    </div>
...
<div>
    <div style="position: absolute; top:50px; border-top: 2.5px solid #A9A9A9; height:91.5%; background-color: black; z-index:100;">
        <ul class="nav nav-pills nav-stacked navbar-inverse"  id="functions">
            ...
            <li class="verticlenar active"><a href="addUser.jsp" class="subnav"><span class="glyphicon glyphicon-list-alt"></span>&nbsp&nbsp添加成员</a></li>
    ...
    <div class="container" style="position: absolute; top: 70px;">
        <div class="row" >
            <div class="col-md-10 col-md-offset-2" style="color: #31b0d5; font-size: 12pt; border-bottom: 1px  solid lightgray ;">
                <span class="glyphicon glyphicon-home"></span>&nbsp&nbsp首页&nbsp&nbsp><span class="glyphicon glyphicon-user"></span>&nbsp&nbsp添加成员
            </div>
        </div>
    </div>
    ...
    <div id="registerBox">
        ...
        <form action="/teamManagement/user/add" name="signupForm1" id="signupForm1">
            ...
            <input type="submit" name="添加" id="submit" value="添加" class="btn btn-info" style="width: 150px;" onclick="check()"><br/>
        </form>
    </div>
